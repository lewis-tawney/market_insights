...
export function TickerCard({ symbol, accentColor }: TickerCardProps) {
  ...
  const getHeatmapColor = (percent: number | null | undefined) => {
    ...
    if (absPercent >= 10) return "bg-red-900/30";
    if (absPercent >= 5) return "bg-orange-900/30";
    if (absPercent >= 2) return "bg-yellow-900/30";
    return "";
  };
      ...
      <div className="space-y-1">
        ...
        <div className="space-y-0.5">
          {(() => {
            ...
            return (
              <div className={`flex items-center justify-between text-xs px-2 py-0.5 rounded ${getHeatmapColor(sma10Percent)}`}>
          ...
          {(() => {
            ...
            return (
              <div className={`flex items-center justify-between text-xs px-2 py-0.5 rounded ${getHeatmapColor(sma20Percent)}`}>
          ...
          {(() => {
            ...
            return (
              <div className={`flex items-center justify-between text-xs px-2 py-0.5 rounded ${getHeatmapColor(sma50Percent)}`}>
          ...
          {(() => {
            ...
            return (
              <div className={`flex items-center justify-between text-xs px-2 py-0.5 rounded ${getHeatmapColor(sma200Percent)}`}>
      ...
      <div className="space-y-1">
        ...
        <div className="space-y-0.5">
          {(() => {
            ...
            return (
              <div className={`flex items-center justify-between text-xs px-2 py-0.5 rounded ${getHeatmapColor(ema9Percent)}`}>
          ...
          {(() => {
            ...
            return (
              <div className={`flex items-center justify-between text-xs px-2 py-0.5 rounded ${getHeatmapColor(ema21Percent)}`}>
